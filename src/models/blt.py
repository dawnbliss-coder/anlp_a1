...
Real BLT uses entropy-based dynamic patching; this uses FIXED-size patches
instead, as the assignment's "simplified" BLT permits. Source bytes equal
target char count exactly on this dataset (8 bits/char), which is what lets
generation stop without an explicit EOS byte."""
