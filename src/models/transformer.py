...
class Seq2SeqTransformer(nn.Module):
    def __init__(
        ...
        # Source is BPE-tokenized (this class is only used for C1-C4), so
        # padding_idx=0 is a dedicated reserved PAD id, not a real content
        # id — safe to zero its gradient, unlike raw byte value 0 would be.
